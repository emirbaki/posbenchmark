...
class N11Spider(scrapy.Spider):
    ...
    async def parse(self, response):
        ...
        for product in response.xpath("//div[@class='pro']"):
            ...
            if subtitle is not None:
                ...
                subtitle = ""
            title = str(product.xpath('.//a/h3/text()').get()) # Adjust the selector for the title
            price_text = str(product.css('.newPrice.cPoint.priceEventClick').xpath('.//ins/text()').get())  # Adjust the selector for the price
    ...
    def closed(self, reason):
        ...
        try:
            ...
            self.logger.warning("n11_prices.csv not found. No pivot table created.")
