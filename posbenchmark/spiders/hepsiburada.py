...
class HepsiburadaSpider(scrapy.Spider):
    ...
    def get_search_url(self, base_url, model):
        return f"{base_url}/ara?q={model.replace(' ', '%20')}"
    ...
    def closed(self, reason):
        ...
        try:
            df = pd.read_csv("hepsiburada_prices.csv")
            ...
            self.logger.warning("hepsiburada_prices.csv not found. No pivot table created.")
